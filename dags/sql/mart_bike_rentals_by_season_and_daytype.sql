DROP TABLE IF EXISTS mart_bike_rentals_by_season_and_daytype;
CREATE TABLE mart_bike_rentals_by_season_and_daytype AS
SELECT
    ds.season_desc,
...
GROUP BY ds.season_desc, day_type
ORDER BY ds.season_desc, day_type;